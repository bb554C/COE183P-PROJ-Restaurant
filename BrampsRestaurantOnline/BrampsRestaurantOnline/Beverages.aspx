<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Beverages.aspx.cs" Inherits="BrampsRestaurantOnline.Beverages" EnableEventValidation="False" %>
    ...
    <asp:Panel ID="BeveragesPanel" CssClass="justify-center padding-left" runat="server">
        <div class="row row-cols-4 margin-2 justify-center">
            <asp:Repeater ID="RepeaterBeverages" runat="server">
                <ItemTemplate>
                    <div id="Item<%#:Eval("MenuItemID")%>" class="card col w-20 limeitems">
